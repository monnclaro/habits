...
export function HabitDay({
  ...
  return (
    <Popover.Root>
      <Popover.Trigger
        className={clsx(
          "h-10 w-10 rounded-lg border-2 border-zinc-800 bg-zinc-900 transition-colors focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-[#09090A]",
          {
      ...
      <Popover.Portal>
        <Popover.Content className="flex min-w-[320px] flex-col rounded-2xl bg-zinc-900 p-6">
          ...
          <span className="leagind-tight mt-1 text-3xl font-extrabold">
            {dayAndMonth}
          </span>
